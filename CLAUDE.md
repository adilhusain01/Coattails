...
- Solana: `@solana/kit` 8 plugin clients and `@solana/kit-plugin-wallet`; never `@solana/web3.js` v1 or wallet-adapter. Transactions are v0. Only exception: `scripts/launch/pool.ts`, because the Meteora DAMM v2 SDK is built on web3.js v1.
