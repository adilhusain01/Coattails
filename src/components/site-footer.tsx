  ...
  return (
    <footer className="border-t">
      <div className="mx-auto grid w-full max-w-6xl gap-3 px-4 py-8 text-xs leading-relaxed text-muted-foreground sm:grid-cols-2 sm:px-6">
        <p>
          Trades come from Periodic Transaction Reports filed with the Clerk of the US House. Members have up to 45
          days to disclose, so every filing shows what the delay cost.
        </p>
        <p>
